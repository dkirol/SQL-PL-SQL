...
/*CALL insert_employees ('Dawid', 'Krrol', 95111111941, 'IT', 1, 'Warszawa', 'Kochanowskiego', '10', 505505505, 'dawid.kirol@gmail.com');*/
...
id_part_payINTEGER GENERATED BY DEFAULT AS IDENTITY,
id_order INTEGER,
...
CURSOR cursor_1 IS
    ...
    WHERE end_pay_date < CURRENT_DATE AND confirmed = 'N';
